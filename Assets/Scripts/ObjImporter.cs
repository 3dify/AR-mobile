...
public class ObjImporter {
	...
	public static Mesh ImportFile (string filePath) {
		...
		populateMeshStruct(ref newMesh,File.OpenText(filePath));
	...
	private static meshStruct createMeshStruct(string filename)
	{
		...
		return createMeshStruct(stream);
	}
	
		
	private static meshStruct createMeshStruct(StreamReader stream)
	{	
		int triangles = 0;
		int vertices = 0;
		int vt = 0;
	...
	private static void populateMeshStruct(ref meshStruct mesh, StreamReader stream)
	{
		string entireText = stream.ReadToEnd();
		stream.Close();
		using (StringReader reader = new StringReader(entireText))
